Function Disable-User
{
    <#
        ...
        .EXAMPLE
          Disable-User -Users "jdoe" -DiabledPassword "Disabled-P@55" -DisabledUserGroup "Terminated-Users" -DisabledOU "Terminated Users"
        ...
        .EXAMPLE
          Disable-User -Users "jdoe","hjohnson","kcrawford" -DisabledPassword "Disabled-P@55" -DisabledUserGroup "Disabled" -DisabledOU "Disabled"
